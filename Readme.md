...
# Parsing + Configuration Script – EM300-MCS - Rev. A

This **Parsing + Configuration** script is designed for the **EM300-MCS** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – EM300-MCS Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **EM300-MCS** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
